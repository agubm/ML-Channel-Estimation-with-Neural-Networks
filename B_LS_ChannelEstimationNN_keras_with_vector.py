...
def ChannelEstimation(ant_array, pilot, noOfNodes):
...
pilot = [6, 8] # here also, i chose 150% of corresponding antenna value.
...
for i in range (len(pilot)): #length of list - pilot and that of antenna array are same.
        ...
        ChannelEstimation(ant_array[i], pilot[i], noOfNodes[i]) # this is the main stuff that calls the function/
